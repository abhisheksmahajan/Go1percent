const pageCommands = {
  clickOnSlider() {
    return this.waitForElementVisible("@corousalSlider", 1000).click(
      "@corousalSlider",
    );
  },
  clickOnTeams() {
    return this.waitForElementVisible("@teamsLogo", 1000).click("@teamsLogo");
  },
  clickOnTermsofuse() {
    return this.waitForElementVisible("@termstoUse", 1000).click("@termstoUse");
  },
  clickOnPrivacypolicy() {
    return this.waitForElementVisible("@privacyPolicy", 1000).click(
      "@privacyPolicy",
    );
  },
  doForgotPassword() {
    return this.click("@forgotPassword")
      ...
      .setValue(glob.userName, "abhi@2644")
      .click("#kc-form-buttons > input");
  },
  clickonRememberme() {
    return this.waitForElementVisible("@remaberMeCheckbox", 1000).click(
      "@remaberMeCheckbox",
    );
  },
  login(username, password) {
    return (
      this.waitForElementVisible("@userName", 1000)
        ...
        //.click('@submit')
        .execute('document.querySelector("#kc-login").click();')
    );
  },
};
